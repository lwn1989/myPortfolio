    ...
    return (
      <div id='portfolio' className='portfolio'>
        ...
        <div className='projects'>
          ...
          <SingleProject textId='pj2' gradientGrade={3} imgAddr={'img/portSite.png'} type={1} firLine='Web Pages' secLine='My Portfolio Website' thiLine='This website is not a template from anywhere, I build it from scratch with React Framework. The image parallax effect is realised by rellax.js, and smooth scrolling effect is made with scroll-into-view plugin. It still needs to be imporved.' fouLine='View Project' link='#' />
